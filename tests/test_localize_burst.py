...
@pytest.fixture()
def ref_burst(ref_metadata: ET.Element, ref_manifest: ET.Element) -> localize_burst.BurstMetadata:
...
@pytest.fixture()
def sec_burst(sec_metadata: ET.Element, sec_manifest: ET.Element) -> localize_burst.BurstMetadata:
...
def test_create_gcp_df(ref_burst: localize_burst.BurstMetadata) -> None:
...
def test_create_geometry(ref_burst: localize_burst.BurstMetadata) -> None:
    burst_number = 8
    real_box = (
        53.17067752190982,
        27.51599975559423,
...
def test_spoof_safe(
    ref_burst: localize_burst.BurstMetadata,
    tmpdir: 'LocalPath',
...
def test_get_region_of_interest(
    ref_burst: localize_burst.BurstMetadata,
    sec_burst: localize_burst.BurstMetadata,
    ref_metadata: ET.Element,
    ref_manifest: ET.Element,
) -> None:
    safe_url = f'{URL_BASE}/SA/S1A_IW_SLC__1SDV_20200616T022252_20200616T022319_033036_03D3A3_5D11.zip'
