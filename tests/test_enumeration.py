...
def test_get_slcs_by_date_and_frame():
    assert enumeration.get_slcs_for_date_and_frame('2018-02-18', 16584) == [
    ...
    assert enumeration.get_slcs_for_date_and_frame('2016-01-29', 1928) == [
    ...
    assert enumeration.get_slcs_for_date_and_frame('2020-12-22', 17949) == [
